...
doTraining = true; 
if doTraining
    Unetnet = trainNetwork(dsTrain,lgraph,options);
    modelDateTime = string(datetime("now",Format="yyyy-MM-dd-HH-mm-ss"));
    dataDir = 'C:\Users\Alessandro\Desktop\IR_1_ResNet18_DeepLabV3_SGDM_8\CityScapes RGB Network\BatchSize8';
    save(fullfile(dataDir,"multispectralUnet-"+modelDateTime+".mat"),"Unetnet");
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% clear all; close all; clc
load multispectralUnet-2022-12-10-03-20-53.mat %will load variable titled "Unetnet"
load rit18_data.mat  
train_data = switchChannelsToThirdPlane(train_data);
val_data   = switchChannelsToThirdPlane(val_data);
test_data  = switchChannelsToThirdPlane(test_data);
...
segmentedImage = segmentMultispectralImage(val_data,Unetnet,predictPatchSize);
...
Results = 'C:\Users\Alessandro\Desktop\IR_1_ResNet18_DeepLabV3_SGDM_8\CityScapes RGB Network\Unet_BatchSize8\Results';
%%
