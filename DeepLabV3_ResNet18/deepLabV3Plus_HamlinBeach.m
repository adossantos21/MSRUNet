...
lgraph = deeplabv3plusLayers([256 256 3], 18, 'resnet18');
lgraph = replaceLayer(lgraph,'data',imageInputLayer([256 256 6],'Name','input'));
lgraph = replaceLayer(lgraph,'conv1',convolution2dLayer([7 7],64,'stride',[2 2],'padding',[3 3 3 3],'Name','conv1'));
lgraph = replaceLayer(lgraph,'dec_upsample2',transposedConv2dLayer([8 8],18,"Stride",[4 4],'Cropping',[2 2 2 2],'Name','fcn'));
lgraph = replaceLayer(lgraph,'classification',pixelClassificationLayer('Name','pixel-class','Classes','auto'));
disp(lgraph.Layers)
...
doTraining = true; 
if doTraining
    DeepLabV3PlusResNet18_6channels = trainNetwork(dsTrain,lgraph,options);
    modelDateTime = string(datetime("now",Format="yyyy-MM-dd-HH-mm-ss"));
    dataDir = 'C:\Users\Alessandro\Desktop\IR_1_ResNet18_DeepLabV3_SGDM_8\CityScapes RGB Network\ResNet18_Unet';
    save(fullfile(dataDir,"DeepLabV3PlusResNet18_6channels_-"+modelDateTime+".mat"),"DeepLabV3PlusResNet18_6channels");
...
segmentedImage = segmentMultispectralImage(val_data,DeepLabV3PlusResNet18_6channels,predictPatchSize);
...
Results = 'C:\Users\Alessandro\Desktop\IR_1_ResNet18_DeepLabV3_SGDM_8\CityScapes RGB Network\DeepLab6Channel\Results';
%%
